...
<div class="home-content">
<h1>FeedingHope</h1>
<p class="lead">Nourishing Communities, Ending Hunger: FeedingHope.</p>
</div>
</div>
</div>
</div>
...
<h2 class="title">Welcome to FeedingHope</h2>
<p class="sub-title">At FeedingHope, we believe in the power of community-driven solutions to tackle the interconnected challenges of food waste and hunger. Our platform serves as a catalyst for change, connecting surplus food providers with individuals and organizations in need.</p>
</div>
<div class="about-content">
<p>FeedingHope" is a website dedicated to addressing two pressing issues: food waste and hunger. With a primary focus on facilitating leftover food donations, FeedingHope aims to bridge the gap between surplus food and those in need. By providing a platform for individuals, businesses, and organizations to easily donate excess food.</p>
...
<p>Provide direct support to an individual, family or community by donating food or offering financial aid..</p>
</div>
</div>
</div>
