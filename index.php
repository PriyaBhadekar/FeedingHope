...
<div class="section-bg" style="background-image: url(img/charity/hero-bg.jpg);"></div>
...
<h1>FeedingHope</h1>
<p class="lead">Donate Food, Spread Hope: FeedingHope.</p>
</div>
</div>
</div>
</div>
...
<p class="sub-title">FeedingHope" is a website dedicated to addressing two pressing issues: food waste and hunger. 
	With a primary focus on facilitating leftover food donations, FeedingHope aims to bridge the gap between surplus food and 
	those in need.</p>
</div>
<div class="about-content">
<p> By providing a platform for individuals, businesses, and organizations to easily donate excess food,
	FeedingHope strives to minimize
	 food waste while simultaneously addressing hunger and food insecurity in communities.</p>
