			...
			<div class="col-md-4">
				<div class="footer">
					<div class="footer-logo">
						<a class="logo" href="#"><img src="img/llogo.png" alt=""></a>
					</div>
					<p>Through the collaborative efforts of donors, volunteers, and partner organizations, FeedingHope endeavors to create a more sustainable and equitable food system, where no one goes hungry and where surplus food is repurposed to serve those in need. </p>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="footer">
					...
					<ul class="footer-contact">
						<li><i class="fa fa-map-marker"></i> FeedingHope,<br> &nbsp;&nbsp;&nbsp; Opp. konaje police station,<br> &nbsp;&nbsp;&nbsp; Bangalore-574199</li>
